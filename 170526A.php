...
<!-- Start OOYALA -->
         ...
         <!-- Gundry_Lectin_Shield_VSL_170526A (Gundry VO sped up - 122% - to match other VO duration) -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', '9nZnhjYjE6fLgfxXL1cKbMte8bueCP8j', {
...
<script>
  if(!$.cookie('returning')){
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '35.67'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
