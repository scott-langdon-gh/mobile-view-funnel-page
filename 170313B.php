...
<!-- Start OOYALA -->
         ...
         <!-- Gundry_Reds_Energy_VSL_170103A (161207A with Drea's "Change" preroll) -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 'Vvbmw4YTE6oExgjkPvdUMyC-pE3TeUXX', {
...
<script>
if(!$.cookie('returning')){
	var minD = <?php if(isset($_GET['d'])) echo $_GET['d']; else echo '29.86'; ?>;
	var secD = minD * 60;
