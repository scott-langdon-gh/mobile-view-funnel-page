...
<body>
	...
	<div class="package-title">
		<div class="container">
			<p class="choose-package"><b>Enjoy More Savings</b></p> 
			<p>Choose Your Gundry VIP Club Subscription</p>	
		</div>
	</div>
	...
	<div class="options-wrapper">
		<div class="options-div">
			...
			<p class="jars bold-nova">1 JAR</p>
					...
					<p class="save bold-nova">$41.95 Per Month</p>
				<div class="cta"><a href="http://gundrymd.com/cmd.php?pid=0a19e007a1e249f5a92468df6b70f2b7&brand=mbg&bn=1&clear=1&mob=1" id="now"><div>BUY NOW</div></a></div>		
			</div>
			<div class="choices choice2 active" id="decision1">
					<p class="jars bold-nova">3 JARS</p>
					<p class="each"><span class="bold-nova">$39.95</span> per jar</p>
					<p class="total">Retail: $209.85</p>
					<p class="save bold-nova">$119.85 Per Month</p>
				<div class="cta"><a href="http://gundrymd.com/cmd.php?pid=f50f9510fa96416c895e962f0c4ee708&brand=mbg&bn=1&clear=1&mob=1" id="now"><div>BUY NOW</div></a></div>
			</div>
			<div class="choices choice3 active" id="last-choice-div">
					<p class="jars bold-nova">6 JARS</p>
					<p class="each"><span class="bold-nova">$37.95</span> per jar</p>
					<p class="total">Retail: $419.70</p>
					<p class="save bold-nova">$227.70 Per Month</p>
				<div class="cta"><a href="http://gundrymd.com/cmd.php?pid=944bc886e317471a80ea388dff880b3c&brand=mbg&bn=1&clear=1&mob=1" id="now"><div>BUY NOW</div></a></div>
			</div>
			<span class="free-shipping"><span class="bold-nova">FREE SHIPPING</span> ON U.S. ORDERS</span>
			<a href="secureOrder_m_cont_180410.php" class="db">
			<div class="blue-save">
				<div class="save-info">
					<p class="big-white"><b>Return to the <span class="red-under">Non-VIP Section</span></b></p>
					<p><span class="tap">Tap here</span> to Leave the Gundry VIP Club</p>
				</div>
