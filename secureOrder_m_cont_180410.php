<?php
	...
	if ($tablet_browser > 0) {
        ...
        header("Location: secureOrder_180410.php");
	}
?>
<!DOCTYPE html>
<html lang="en">
	...
	<div class="options-wrapper">
		<div class="options-div">
			...
			<img src="images/most.png" alt="" class="most">
				...
				<div class="cta"><a href="http://gundrymd.com/cmd.php?pid=9e938a47eab742e78fa3fd2cab5e3340&brand=mbg&bn=1&clear=1&mob=1" id="now"><div>BUY NOW</div></a></div>
			</div>
			<div class="choices choice2 active" id="decision1">
				...
				<div class="cta"><a href="http://gundrymd.com/cmd.php?pid=02b66eaf18ff4babb549ebc9f86ea40f&brand=mbg&bn=1&clear=1&mob=1" id="now"><div>BUY NOW</div></a></div>
			</div>
			<div class="choices choice3 active" id="last-choice-div">
				...
				<div class="cta"><a href="http://gundrymd.com/cmd.php?pid=5fb9c7bc9dab4438a20123f555487339&brand=mbg&bn=1&clear=1&mob=1" id="now"><div>BUY NOW</div></a></div>
			</div>
			<span class="free-shipping"><span class="bold-nova">FREE SHIPPING</span> ON U.S. ORDERS OVER $60</span>
			<a href="JoinCont_180410.php" class="db">
			<div class="blue-save">
				<div class="save-info">
