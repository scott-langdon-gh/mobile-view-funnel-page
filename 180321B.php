...
<!-- Start OOYALA 
Gundry Total Restore VSL 180320A-->
          <style type="text/css">
            .oo-control-bar{
             visibility: hidden;
             pointer-events: none;
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 'JnZHhxZTE6kjKLtRgtoMM2a7W4Ugj9X9', {
...
<script>
  if(!$.cookie('returning180308A')){
    // Button Timer: 39:49 (price)
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '39.816'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
