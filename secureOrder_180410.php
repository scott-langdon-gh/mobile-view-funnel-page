<?php
	...
	if ($tablet_browser > 0) {
		...
		header("Location: secureOrder_m_cont_180410.php");
	}
	else {
...
<head>
	...
	<style>
		...
		.insideContainer{width: 660px; margin: 0 auto; margin-left: 175px;}
		.productImage{margin-top: 50px;}
	</style>
	<!--[if lt IE 9]>
			...
			<div class="product">
				<div class="insideContainer">
					<div class="productImage">
						...
						<img src="images/seal_141px.png" class="guarantee_icon" style="position: absolute; top: 55px; left: -75px;" />
					</div>
					<div class="clear"></div>
