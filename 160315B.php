...
<div class="early-access-box container content">
        ...
        <!-- video -->
            ...
            <span class="LimelightEmbeddedPlayer" id="Gundry_Lectin_Shield_VSL_160315B">
			<script src="//video.limelight.com/player/embed.js"></script>
            <object type="application/x-shockwave-flash" id="limelight_player_114574" name="limelight_player_114574" class="LimelightEmbeddedPlayerFlash" width="679" height="382" data="//video.limelight.com/player/loader.swf">
            <param name="movie" value="//video.limelight.com/player/loader.swf"/>
            <param name="wmode" value="window"/>
            <param name="allowScriptAccess" value="always"/>
            <param name="allowFullScreen" value="true"/>
            <param name="flashVars" value="channelId=f45ca2d17cae43068d9049d1d7f30697&amp;deepLink=true&amp;playerForm=3408cce3252244e9b8db28df9f21f924"/></object>
			<script>LimelightPlayerUtil.initEmbed('limelight_player_114574');</script>
            </span>
