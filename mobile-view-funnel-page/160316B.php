...
<div class="early-access-box container content">
        ...
        <!-- video -->
            ...
            <span class="LimelightEmbeddedPlayer" id="Gundry_Lectin_Shield_VSL_160316B">
			<script src="//video.limelight.com/player/embed.js"></script>
            <object type="application/x-shockwave-flash" id="limelight_player_655809" name="limelight_player_655809" class="LimelightEmbeddedPlayerFlash" width="679" height="382" data="//video.limelight.com/player/loader.swf">
            <param name="movie" value="//video.limelight.com/player/loader.swf"/>
            <param name="wmode" value="window"/>
            <param name="allowScriptAccess" value="always"/>
            <param name="allowFullScreen" value="true"/>
            <param name="flashVars" value="channelId=56e8c7eec92b4c199fada22dad17e362&amp;deepLink=true&amp;playerForm=3408cce3252244e9b8db28df9f21f924"/></object>
			<script>LimelightPlayerUtil.initEmbed('limelight_player_655809');</script>
            </span>
