...
<!-- Start OOYALA 
Gundry_Total_Restore_VSL_180312B -->
          <style type="text/css">
            .oo-control-bar{
             visibility: hidden;
             pointer-events: none;
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', '1rbjdvZTE6hGs9IB0XxVhVvD5wg78kqR', {
...
<script>
  if(!$.cookie('returning')){
    // Button timer: 36:14
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '36.233'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
