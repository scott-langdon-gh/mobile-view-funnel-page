...
<!-- Start OOYALA -->
         <!--Gundry_Lectin_Shield_VSL_170420A-->
          <style type="text/css">
            .oo-control-bar{
             visibility: hidden;
             pointer-events: none;
         ...
         <!-- Gundry_Lectin_Shield_VSL_170403B_dummy.mp4 (fixe audio, Kevin’s improved preroll) -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 'FnNzN2YTE6R2uBGBcBuYENQIIGlkBqmV', {
...
<script>
if(!$.cookie('returning')){
	var minD = <?php if(isset($_GET['d'])) echo $_GET['d']; else echo '34.97'; ?>;
	var secD = minD * 60;
