...
<!-- Start OOYALA -->
         ...
         <!-- Gundry_Total_Restore_VSL_180215A -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 'xpcDhkZTE6in0zzldGWJvRk0tB6_Ssq8', {
...
<script>
  if(!$.cookie('returning')){
    // Button Timer - 00:39:33:00
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '39.55'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
