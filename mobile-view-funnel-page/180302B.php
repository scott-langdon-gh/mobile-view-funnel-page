...
<?php if($n=='tba' || $n=='aol'){ ?><p>Advertisement</p><?php } ?>
...
Gundry_Total_Restore_VSL_180302A-->
         ...
         <!-- Gundry_Total_Restore_VSL_180130B -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 'h4cTdrZTE6HE75EQjYfje_j_ABcUrinq', {
...
<!-- End OOYALA -->
        	...
        	<a href="assessment180302A.php" id="button" class="orderpage_btnB" target="_blank">NEXT STEP</a>
        	</div>
...
<a href="http://gundrymd.com/terms">Terms & Conditions</a>&nbsp; &nbsp;|&nbsp; &nbsp;<?php if($n=='tba' || $n=='aol'){ ?>  Click <a href="vslScript.php" target="_BLANK">here</a> to view Text <?php } ?>&nbsp; &nbsp;|&nbsp; &nbsp;<a href="http://gundrymd.com/privacy">Privacy Policy</a>&nbsp; &nbsp;|&nbsp; &nbsp; 9465 Wilshire Boulevard, Suite 300 Beverly Hills, California, 90212</text> </p>
          </div> 
                </div>
...
<script>
  if(!$.cookie('returning')){
    // Button PRICE: 37:46
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '37.766'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
