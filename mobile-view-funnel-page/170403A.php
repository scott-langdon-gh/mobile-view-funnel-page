...
<!-- Start OOYALA -->
         ...
         <!-- Gundry_Lectin_Shield_VSL_170403A_dummy.mp4 (Fixed audio, Kevin’s fresh food preroll) -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', '9wbTZuYTE6sG4cvzU2WKMvrb-XltnkI1', {
...
<script>
if(!$.cookie('returning')){
	var minD = <?php if(isset($_GET['d'])) echo $_GET['d']; else echo '34.58'; ?>;
	var secD = minD * 60;
