...
<!-- Start OOYALA -->
         ...
         <!-- Gundry_Total_Restore_VSL_180523B -->
         ...
         <style>
            ...
            .oo-start-screen {
              background-image: url("images/Gundry_hallway.jpg");
        ...
        <script>
          ...
          OO.ready(function() {
            var lastTriggerPos;
            mplayer = OO.Player.create('LimelightEmbeddedPlayerFlash', '5lbmVlZjE6XAkODWKRj7ct0yV8zLJ2L-', playerParam);
            mplayer.mb.subscribe(OO.EVENTS.PLAYBACK_READY, '5lbmVlZjE6XAkODWKRj7ct0yV8zLJ2L-', function(eventName) {
                title = mplayer.getCurrentItemTitle();
                var vData = mplayer.getItem();
                dur = parseInt(vData.time);
            });
            window.setInterval(function(){
                mplayer.mb.subscribe(OO.EVENTS.PLAYHEAD_TIME_CHANGED, '5lbmVlZjE6XAkODWKRj7ct0yV8zLJ2L-', function(eventName) {
...
<a href="http://gundrymd.com/terms">Terms & Conditions</a>&nbsp; &nbsp;|&nbsp; &nbsp;<?php if($n=='tba' || $n=='tbam'){ ?>  Click <a href="vslScript180523B.php" target="_BLANK">here</a> to view Text <?php } ?>&nbsp; &nbsp;|&nbsp; &nbsp;<a href="http://gundrymd.com/privacy">Privacy Policy</a>&nbsp; &nbsp;|&nbsp; &nbsp; 9465 Wilshire Boulevard, Suite 300 Beverly Hills, California, 90212</text> </p>
          </div> 
                </div>
...
<script>
  if(!$.cookie('returning180308A')){
    // Button PRICE: 38:21
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '38.35'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
