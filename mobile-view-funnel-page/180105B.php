...
<!-- Start OOYALA -->
         ...
         <!-- Gundry_Total_Restore_VSL_180105B -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 'c2NTN2ZDE6HxCt_xuU_srR8aoq5UjAJx', {
...
<script>
  if(!$.cookie('returning')){
    //button timer 38:20
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '38.33'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
