...
<!-- Start OOYALA -->
         ...
         <!-- Gundry_Lectin_Shield_VSL_170413A (Jennifer/David's "Kristen Kurry" preroll + 170403 VSL) -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 's3MXFyYTE6QHgQTH72keLagxti4z13nr', {
...
<script>
if(!$.cookie('returning')){
	var minD = <?php if(isset($_GET['d'])) echo $_GET['d']; else echo '35.33'; ?>;
	var secD = minD * 60;
