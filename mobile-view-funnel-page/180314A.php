...
<!-- Start OOYALA 
Gundry_Total_Restore_VSL_180313B-->
          <style type="text/css">
            .oo-control-bar{
             visibility: hidden;
             pointer-events: none;
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 'huaGtvZTE6GA6K0dNeYfRpt0i0-GVTbZ', {
...
<script>
  if(!$.cookie('returning180308A')){
    // Button Timer - 38:50 (price)
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '38.833'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
