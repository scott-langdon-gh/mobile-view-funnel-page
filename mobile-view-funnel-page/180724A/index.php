...
<html lang="en"><head>
	...
	<style>
		...
		header p{background: url("assets/images/hero_logo.png") no-repeat; padding-left: 700px; height: 90px !important; margin:0px auto; margin-bottom:10px;}
		...
		.optIn2{padding-top: 50px; padding-bottom: 60px; padding-left: 0px; padding-right: 0px; background:transparent url('assets/images/optin_bg2.png') no-repeat scroll center center; background-clip: border-box; background-origin: padding-box; background-size: auto auto; margin-bottom: -10px;}
    ...
    .shield li{background: url("assets/images/favicon.png") no-repeat 9px 7px; width: 270px; list-style: none;
...
<?php if($n=='tba' || $n=='tbam'){ ?><p>Advertisement</p><?php } ?>
...
<!-- Start OOYALA Gundry Total Restore VSL 180711B-->
          <style type="text/css">
            .oo-control-bar{
             visibility: hidden;
             pointer-events: none;
           ...
           .oo-state-screen-title {display: none;}
           .oo-watermark-container { display: none; }
          .oo-state-screen-poster {background-image: url("images/Gundry_hallway.jpg") !important}
         </style>
         ...
         <style>
            ...
            .oo-start-screen {
              background-image: url("assets/images/Gundry_hallway.jpg");
        ...
        <script>
          ...
          OO.ready(function() {
            var lastTriggerPos;
            mplayer = OO.Player.create('LimelightEmbeddedPlayerFlash', 'tpZGVxZjE6gPNc5_DsgvSGyv3WGzRbxN', playerParam);
            mplayer.mb.subscribe(OO.EVENTS.PLAYBACK_READY, 'tpZGVxZjE6gPNc5_DsgvSGyv3WGzRbxN', function(eventName) {
                title = mplayer.getCurrentItemTitle();
                var vData = mplayer.getItem();
                dur = parseInt(vData.time);
            });
            window.setInterval(function(){
                mplayer.mb.subscribe(OO.EVENTS.PLAYHEAD_TIME_CHANGED, 'tpZGVxZjE6gPNc5_DsgvSGyv3WGzRbxN', function(eventName) {
...
<!-- End OOYALA -->
        	...
        	<a href="assessment.php" id="button" class="orderpage_btnB" target="_blank">NEXT STEP</a>
        	</div>
	...
	<img src="assets/images/gundry-309x300_2.png" id="doctor" />
    <h1>DR. GUNDRY</h1>
...
<?php if($n=='tbam'){ ?>
           <p class="smftrtext">Click <a href="../user_group.php" target="_BLANK" onclick="return !window.open(this.href, 'Google', 'scrollbars=1,width=700,height=500')">here</a> to see a user group study on Total Restore.</p>
<?php } ?>
...
<a href="http://gundrymd.com/terms">Terms & Conditions</a>&nbsp; &nbsp;|&nbsp; &nbsp;<?php if($n=='tba' || $n=='tbam'){ ?>  Click <a href="../vslScript180302.php" target="_BLANK">here</a> to view Text <?php } ?>&nbsp; &nbsp;|&nbsp; &nbsp;<a href="http://gundrymd.com/privacy">Privacy Policy</a>&nbsp; &nbsp;|&nbsp; &nbsp; 9465 Wilshire Boulevard, Suite 300 Beverly Hills, California, 90212</text> </p>
          </div> 
                </div>
...
<script>
  if(!$.cookie('returning180308A')){
    // Button PRICE: 37:50
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '37.833'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
