...
<!-- Start OOYALA -->
         ...
         <!-- Gundry Total Restore VSL 171116A new iteration -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', '81a29zZDE6SCjPvTDPBSN6UEcVqwxqn0', {
...
<script>
  if(!$.cookie('returning')){
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '38.8'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
