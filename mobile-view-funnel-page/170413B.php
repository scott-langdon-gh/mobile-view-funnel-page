...
<!-- Start OOYALA -->
         ...
         <!-- Gundry_Lectin_Shield_VSL_170413B (Jason's "A Hidden Danger" preroll + 170403 VSL) -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 'JnaHByYTE6xF_h_UyXww3zNnFo1YSyx7', {
...
<script>
if(!$.cookie('returning')){
	var minD = <?php if(isset($_GET['d'])) echo $_GET['d']; else echo '34.6'; ?>;
	var secD = minD * 60;
