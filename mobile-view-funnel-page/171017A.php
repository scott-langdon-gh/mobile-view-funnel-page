...
<?php if($n=='tab'){ ?><p>Advertisement</p><?php } ?>
...
<!-- Start OOYALA -->
         ...
         <!-- Gundry_Lectin_Shield_VSL_171016A (170526A with Vital Reds "2 Things" close) -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', '5kMjYyZDE68xZtuqJ6VUycKeoOppBrgi', {
...
<a href="http://gundrymd.com/terms">Terms & Conditions</a>&nbsp; &nbsp;| <?php if($n=='tab'){ ?>  Click <a href="vslScript.php" target="_BLANK">here</a> to view Text | <?php } ?> &nbsp; &nbsp;<a href="http://gundrymd.com/privacy">Privacy Policy</a>&nbsp; &nbsp;|&nbsp; &nbsp; 9465 Wilshire Boulevard, Suite 300 Beverly Hills, California, 90212</text> </p>
          </div> 
                </div>
...
<script>
  if(!$.cookie('returning')){
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '35.70'; ?> * 60000; //  ** Price Time ** 
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
