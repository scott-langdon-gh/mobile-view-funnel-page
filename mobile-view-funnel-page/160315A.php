...
<div class="early-access-box container content">
        ...
        <!-- video -->
            ...
            <span class="LimelightEmbeddedPlayer" id="Gundry_Lectin_Shield_VSL_160315A">
			<script src="//video.limelight.com/player/embed.js"></script>
            <object type="application/x-shockwave-flash" id="limelight_player_293894" name="limelight_player_293894" class="LimelightEmbeddedPlayerFlash" width="679" height="382" data="//video.limelight.com/player/loader.swf">
            <param name="movie" value="//video.limelight.com/player/loader.swf"/>
            <param name="wmode" value="window"/>
            <param name="allowScriptAccess" value="always"/>
            <param name="allowFullScreen" value="true"/>
            <param name="flashVars" value="channelId=45597b3cb9714546a99d6da8e1d0a4dd&amp;deepLink=true&amp;playerForm=3408cce3252244e9b8db28df9f21f924"/></object>
			<script>LimelightPlayerUtil.initEmbed('limelight_player_293894');</script>
            </span>
