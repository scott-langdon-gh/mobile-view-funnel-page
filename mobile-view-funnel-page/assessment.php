	...
	<div class='wrapper'>
		<section class="main" id='surveyMain'>
			<div id='surveyContainer' class="container">
				<form id='survey' action='http://thenewgutfix.com/180509A/secureOrder.php' method='post'>
					<ol>
						<li><h2>Are you a...</h2>
						...
						<p><a href="http://thenewgutfix.com/180509A/secureOrder.php">Skip this step</a></p>
					</ol>
				</form><!--End of Survey-->
