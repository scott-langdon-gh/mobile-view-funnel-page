...
<!-- End OOYALA -->
        	...
        	<a href="assessment180308A.php" id="button" class="orderpage_btnB" target="_blank">NEXT STEP</a>
        	</div>
...
<a href="http://gundrymd.com/terms">Terms & Conditions</a>&nbsp; &nbsp;|&nbsp; &nbsp;<?php if($n=='tba' || $n=='tbam'){ ?>  Click <a href="vslScript.php" target="_BLANK">here</a> to view Text <?php } ?>&nbsp; &nbsp;|&nbsp; &nbsp;<a href="http://gundrymd.com/privacy">Privacy Policy</a>&nbsp; &nbsp;|&nbsp; &nbsp; 9465 Wilshire Boulevard, Suite 300 Beverly Hills, California, 90212</text> </p>
          </div> 
                </div>
