...
<!-- Start OOYALA -->
         ...
         <!-- GMD_lectin_Shield_VSL_170517A.mp4 -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 's4NWY4YjE6D50cHc2V9ECUmSTR9iQM4V', {
...
<script>
  if(!$.cookie('returning')){
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '27.3'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
