...
<!-- Start OOYALA 
Gundry_Total_Restore_VSL_180321A-->
          <style type="text/css">
            .oo-control-bar{
             visibility: hidden;
             pointer-events: none;
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 'doMjZyZTE69uM4dmnGMPK7DSdwfUt0tt', {
...
<script>
  if(!$.cookie('returning180308A')){
    // Button Timer - 37:34 (price)
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '37.56'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
