...
<head>
	...
	<link rel="stylesheet" href="css/new-style180712A.css">
	<style>
...
.choice1:hover .jars, .choice2:hover .jars, .choice3:hover .jars {
	font-size: 24px;
	color: #474648;
	font-weight: bold;
}
.choice1:hover .price, .choice2:hover .price, .choice3:hover .price {
	color: #474648;
	font-size: 17px;
	font-weight: bold;
}
.choice1:hover .exact, .choice2:hover .exact, .choice3:hover .exact {
	color: #474648;
	font-size: 12.75px;
	top: 24px;
	font-weight: bold;
}
.choice1:hover .savings, .choice2:hover .savings, .choice3:hover .savings {
	color: #2f3779;
	left: 142px;
	top: 57px;
	font-weight: bold;
...
<div id="main">
	<div class="container">
		<h1 id="intro">Special Subscribers-Only Offer on Gundry MD Total Restore</h1>
		<hr class="reg-hr">
