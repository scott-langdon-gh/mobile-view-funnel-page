...
<head>
	...
	<style>
		...
		.top-list li{font-family: 'Proxima_Nova_SemiBold'; list-style-image: url("images/red-check2.png");
...
<div id="main">
		...
		<div class="choice choice3">
			...
			<div class="list-div">
				...
				<div class="subscribe-div" id="main-subscribe">
					...
					<div class="checkbox"><input type="checkbox" id="inputy" name="inputy"><img src="images/red-check.png" class="red-check" id="sub-check" alt=""></div><p class="yes-text yes-text2"> <span class="sub-save">YES!</span> I want to sign up for GUNDRY VIP CLUB and <span class="save-ten">Save 10%</span>!</p>
	...
	<div class="container">
			...
			<div id="LimelightEmbeddedPlayerFlash" style="width:550px; height:298px; margin: 20px auto;"></div>
          <!-- start OOYALA ADD 
       ...
       OO.ready(function() {
								...
								window.pp = OO.Player.create('LimelightEmbeddedPlayerFlash', 'h4cTdrZTE6HE75EQjYfje_j_ABcUrinq', playerParam);});
              </script>
			</div>
			...
			<div class="product">
				<div class="insideContainer">
					<div class="productImage">
						<img src="images/Total-Restore.png" class="firstImage" style="height: auto; width: 164px; position: relative; left: 0px;"/>
					</div>
					<div class="clear"></div>
...
<script src="js/book_subscribe_171116.js"></script>
<script>
