...
<!-- Start OOYALA -->
         ...
         <!-- Gundry_Total_Restore_VSL_180105C -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 'xjNTN2ZDE6OGG8xae-v8znyMW2bkVgZh', {
...
<script>
  if(!$.cookie('returning')){
    //button timer: 37:57
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '37.95'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
