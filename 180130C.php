...
<html lang="en"><head>
  ...
  <style>
    ...
    .content{box-shadow: 0 0 25px #ccc; height: 529px;}
    ...
    .right-column{width: 203px; float: right; padding-right:20px; margin-right:10px; color: #4A4A4A;}
    ...
    h1 {font-size:23px; color:#27377a; text-transform: uppercase; margin-bottom: 0; margin-top: 80px;}
    ...
    /*.right-column h1 + ul{color: #4A4A4A; padding-left: 0; list-style-type: none;}*/
    /*.right-column ul li{padding: 10px 0;}*/
    .right-column .list.bt{border-top: 2px solid #C0C0C0;}
    .right-column .list{padding: 10px 0; margin: 0;}
    .right-column .text{display: inline-block; width: 185px; font-size: 14px;}
    .right-column .bullet{margin-right: 5px; vertical-align: 19px;}
    .right-column .bullet.last{vertical-align: 8px;}
</style>  
   <!--[if lt IE 9]>
...
<!-- Start OOYALA -->
         ...
         <!-- Gundry_Total_Restore_VSL_180130A -->
      ...
      OO.ready( function() {
        ...
        // Create Player
        window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 'Z0eGk2ZTE6QJ5FwCByLvRgxoK7y6pW5g', {
...
<!-- End OOYALA -->
          ...
          <a href="secureOrder_cont.php" id="button" class="orderpage_btnB" target="_blank">NEXT STEP</a>
          </div>
  ...
  <div class="right-column">
    ...
    <h1 class="fnt16">What you’ll learn:</h1>
    
    <p class="list"><span class="bullet">&bullet;</span> <span class="text">The hidden health problem affecting millions of Americans — but few know it</span></p>
    <p class="list bt"><span class="bullet">&bullet;</span> <span class="text">Why weight gain, fatigue, and bloating are <b>WARNING SIGNS</b> for bigger issues</span></p>
   <p class="list bt"> <span class="bullet">&bullet;</span> <span class="text">The two “desserts” proven to soothe digestion and make skin glow</span></p>
    <p class="list bt"><span class="bullet last">&bullet;</span> <span class="text">The simple mineral scientists say can transform your gut</span></p>
  </div>
  <div class="clear"></div>
</div><br />
<!-- main content -->
...
<script>
  if(!$.cookie('returning')){
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '37.38'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
