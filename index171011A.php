...
<!-- Start OOYALA -->
         ...
         <!-- 170504C with new audio and script changes -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 'Fvd3N5YzE6-rAgtbJy0fe5WzdFHLgtV6', {
...
<script>
  if(!$.cookie('returning')){
    // Button Timer - 36:54
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '36.9'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
