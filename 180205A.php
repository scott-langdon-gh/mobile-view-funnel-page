...
<?php if($n=='cad' || 'ob'){ ?><p>Advertorial</p><?php } ?>
...
<!-- Start OOYALA -->
         ...
         <!-- Gundry_Total_Restore_VSL_180205A -->
      ...
      OO.ready( function() {
      	...
      	// Create Player
      	window.pp = OO.Player.create( 'LimelightEmbeddedPlayerFlash', 'M1czA5ZTE65ECeNwTTXwWG0wF5tF-jZN', {
