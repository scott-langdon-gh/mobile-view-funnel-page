...
Gundry_Total_Restore_VSL_180302A-->
        ...
        <script>
          ...
          OO.ready(function() {
            var lastTriggerPos;
            mplayer = OO.Player.create('LimelightEmbeddedPlayerFlash', '5rcGFrZjE63zieWn1KXV5T3cjq3VWzL_', playerParam);
            mplayer.mb.subscribe(OO.EVENTS.PLAYBACK_READY, '5rcGFrZjE63zieWn1KXV5T3cjq3VWzL_', function(eventName) {
                title = mplayer.getCurrentItemTitle();
                var vData = mplayer.getItem();
                dur = parseInt(vData.time);
            });
            window.setInterval(function(){
                mplayer.mb.subscribe(OO.EVENTS.PLAYHEAD_TIME_CHANGED, '5rcGFrZjE63zieWn1KXV5T3cjq3VWzL_', function(eventName) {
...
<a href="http://gundrymd.com/terms">Terms & Conditions</a>&nbsp; &nbsp;|&nbsp; &nbsp;<?php if($n=='tba' || $n=='tbam'){ ?>  Click <a href="../vslScript180706A.php" target="_BLANK">here</a> to view Text <?php } ?>&nbsp; &nbsp;|&nbsp; &nbsp;<a href="http://gundrymd.com/privacy">Privacy Policy</a>&nbsp; &nbsp;|&nbsp; &nbsp; 9465 Wilshire Boulevard, Suite 300 Beverly Hills, California, 90212</text> </p>
          </div> 
                </div>
...
<script>
  if(!$.cookie('returning180308A')){
    // Button PRICE: 40:10
    var delay = <?php if(isset($_GET['del'])) echo $_GET['del']; else echo '40.1666'; ?> * 60000;
    setTimeout(function() {
      $("#CTALink a").show();
    }, delay);
