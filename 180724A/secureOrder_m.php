...
<body>
	...
	<div class="options-wrapper">
		<div class="options-div">
			...
			<img src="assets/images/most.png" alt="" class="most">
			...
			<div class="blue-save">
				...
				<img src="assets/images/hand-point.png" alt="">
				<div class="clear"></div>
			</div>
		</a>
		</div>
	...
	<div class="gundry-div">
		<div class="gundry-pic-div">
			<img src="assets/images/docGun.jpg" alt="">
		</div>
		<div class="basic-div">
	...
	<div class="basic-div faqs-div">
		...
		<div class="question-div">
			<h3><img src="assets/images/blue-triangle.png" alt="" class="blue-triangle"> How many bottles should I order?</h3>
		...
		<div class="question-div">
			<h3><img src="assets/images/blue-triangle.png" alt="" class="blue-triangle"> What are the ingredients in Gundry MD Total Restore?</h3>
			<div class="hidden-answer">
				<img src="assets/images/restore-supp.png" class="answer" />
			</div>
		</div>
		<div class="question-div">
			<h3><img src="assets/images/blue-triangle.png" alt="" class="blue-triangle"> How Safe Is Gundry MD Total Restore? Are There Any Side Effects?</h3>
		...
		<div class="question-div">
			<h3><img src="assets/images/blue-triangle.png" alt="" class="blue-triangle"> How do I use Gundry MD Total Restore?</h3>
			<div class="hidden-answer">
		...
		<div class="question-div">
			<h3><img src="assets/images/blue-triangle.png" alt="" class="blue-triangle"> When can I expect results?</h3>
		...
		<div class="question-div">
			<h3><img src="assets/images/blue-triangle.png" alt="" class="blue-triangle"> What if Total Restore doesn't work for me? Is there a guarantee?</h3>
			<div class="hidden-answer">
	...
	<div class="basic-div" id="last-div">
		...
		<img src="assets/images/Total-Restore-mbg.png"/>
		</div>
